...
public class UserController {
    ...
    public void setEmployerRepo(IEmployer dao) {this.employerRepo=dao; }

    public void setUserRepo(IUser dao) {
        this.userRepo=dao;
    }

    public void setRoleRepo(IRole dao) {this.roleRepo=dao; }
    ...
    //SignUp
    @PreAuthorize("hasAnyAuthority('SUPER', 'STUDENT')")
    ...
    @PreAuthorize("hasAnyAuthority('SUPER', 'EMPLOYER')")
